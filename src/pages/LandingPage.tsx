...
const features = [
  { title: 'Real-time Monitoring', description: '24/7 surveillance with instant alerts', icon: '👁️' },
  { title: 'Compliance Management', description: 'Automated regulatory reporting', icon: '📋' },
  { title: 'Biometric Access', description: 'Facial & fingerprint recognition', icon: '🔒' },
];
      ...
      <main className="container mx-auto px-4 py-20">
        ...
        <section className="text-center max-w-3xl mx-auto" aria-labelledby="landing-page-title">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Button variant="secondary" onClick={() => navigate('/demo')} size="lg">
              Request Demo
            </Button>
          </div>
        </section>
        ...
        {/* Features Section */}
        <section className="mt-24 grid md:grid-cols-3 gap-8" aria-labelledby="features-title">
